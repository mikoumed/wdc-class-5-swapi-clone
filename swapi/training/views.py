...
def text_response(request):
    ...
    """
    return HttpResponse('Simple text message', content_type='text/plain')
...
def looks_like_json_response(request):
    ...
    """
    return HttpResponse("[{'content': 'this is not a JSON'}]", content_type='text/plain')
...
def simple_json_response(request):
    ...
    object manually.
    """
    return HttpResponse("[{'content': 'this is not a JSON'}]", content_type='JSON')
...
def json_response(request):
    ...
    """
    return JsonResponse({'content': 'this is a JSON'})
...
def url_int_argument(request, first_arg):
    ...
    """
    return JsonResponse({'arg':first_arg}, status=200)
